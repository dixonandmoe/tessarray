...
// Licensed under the terms of the MIT license. Please see LICENSE file in the project root for terms.
var Tessarray=function(t,s){this.options=s||{},this.setOptionValue("containerClass",!1),this.setOptionValue("selectorClass",!1),this.setOptionValue("defaultCategory",!1),this.setOptionValue("resize",!0),this.setOptionValue("timingFunction","ease-in"),this.setOptionValue("duration",375),this.setOptionValue("delay",0),this.setOptionValue("flickr",{}),this.dimensionsLoaded=[],this.containerHasLoaded=!1,this.boxObjects=[],this.boxNodes=[];var i;i=this.options.containerClass?document.getElementsByClassName(this.options.containerClass)[0].getElementsByClassName(t):document.getElementsByClassName(t);for(var e="transform "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, height "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, left "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, top "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, width "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, opacity "+this.options.duration+"ms ease-in",o=0;o<i.length;o++)this.boxNodes[o]=i[o],this.boxNodes[o].style.position="absolute",this.boxNodes[o].style.opacity="0",this.boxNodes[o].style.transition=e,this.boxNodes[o].style["-webkit-transition"]=e,console.log(this.boxNodes[o].style.transition),this.boxObjects[o]=new TessarrayBox(i[o],o,this);if(this.specifiedContainerWidth=!!this.options.flickr.containerWidth,this.options.containerClass&&(this.container=document.getElementsByClassName(this.options.containerClass)[0],this.containerLoad(),this.setContainerWidth(),""===this.container.style.position&&(this.container.style.position="relative"),this.options.flickr.containerPadding?this.options.flickr.containerPadding.bottom?this.containerPaddingBottom=this.options.flickr.containerPadding.bottom:this.containerPaddingBottom=this.options.flickr.containerPadding:this.containerPaddingBottom=10,this.options.resize&&window.addEventListener("resize",this.renderIfNecessary.bind(this))),this.options.selectorClass){this.selectors=document.getElementsByClassName(this.options.selectorClass);for(var o=0;o<this.selectors.length;o++){var n=this.selectors[o].getAttribute("data-category");this.selectors[o].addEventListener("click",this.sortByCategory.bind(this,n))}}},TessarrayBox=function(t,s,i){this.index=s,this.tessarray=i,this.classes={};for(var e=t.getAttribute("class").split(" "),o=0;o<e.length;o++)this.classes[e[o]]=t.dataset[e[o]]||null;if(i.dimensionsLoaded[s]=!1,t.getAttribute("data-aspect-ratio")||t.getAttribute("data-height")&&t.getAttribute("data-width"))this.givenAspectRatio=!0,i.setAspectRatio(i,this,t,s);else{this.givenAspectRatio=!1;var n=t.querySelector("img").getAttribute("src"),a=new Image,r=this;a.onload=function(){r.aspectRatio=this.width/this.height,i.confirmLoad(s)},a.src=n}};Tessarray.prototype.setOptionValue=function(t,s){void 0===this.options[t]&&(this.options[t]=s)},Tessarray.prototype.setContainerWidth=function(){!this.specifiedContainerWidth&&this.options.containerClass&&(this.options.flickr.containerWidth=this.container.clientWidth)},Tessarray.prototype.setAspectRatio=function(t,s,i,e){i.getAttribute("data-aspect-ratio")?(s.aspectRatio=parseFloat(i.getAttribute("data-aspect-ratio")),t.confirmLoad(e)):i.getAttribute("data-height")&&i.getAttribute("data-width")&&(s.aspectRatio=parseFloat(i.getAttribute("data-height"))/parseFloat(i.getAttribute("data-width")),t.confirmLoad(e));var o=i.querySelector("img").getAttribute("src"),n=new Image;n.onload=function(){i.style.opacity="1"},n.src=o},Tessarray.prototype.confirmLoad=function(t){this.dimensionsLoaded[t]=!0,!this.deterimineIfBoxesLoaded()||!this.containerHasLoaded&&this.options.containerClass||this.initialRender()},Tessarray.prototype.containerLoad=function(){this.containerHasLoaded=!0,this.deterimineIfBoxesLoaded()&&this.initialRender()},Tessarray.prototype.deterimineIfBoxesLoaded=function(){for(var t=0;t<this.dimensionsLoaded.length;t++)if(!this.dimensionsLoaded[t])return!1;return!0},Tessarray.prototype.renderIfNecessary=function(){this.specifiedContainerWidth||this.options.flickr.containerWidth===this.container.clientWidth||this.renderBoxes()},Tessarray.prototype.initialRender=function(){this.options.containerClass&&(this.container.style.opacity="1"),this.options.selectorClass&&this.options.defaultCategory?this.sortByCategory(this.options.defaultCategory):(this.setSelectedBoxes(this.boxObjects),this.renderBoxes())},Tessarray.prototype.sortByCategory=function(t){if(""===t)var s=this.boxObjects;else var i=this.boxObjects.filter(function(s){return void 0!==s.classes[t]}),s=i.sort(function(s){return s.classes[t]});this.setSelectedBoxes(s),this.renderBoxes()},Tessarray.prototype.setSelectedBoxes=function(t){console.log("setSelectedBoxes"),this.selectedBoxes=t,this.oldIndexes=this.indexes,this.indexes=this.selectedBoxes.map(function(t){return t.index}),this.ratios=t.map(function(t){return parseFloat(t.aspectRatio)})},Tessarray.prototype.renderBoxes=function(){this.setContainerWidth();var t=require("justified-layout")(this.ratios,this.options.flickr);if(this.options.containerClass){var s=t.boxes[t.boxes.length-1].top+t.boxes[t.boxes.length-1].height+this.containerPaddingBottom;this.container.style.height=s.toString()+"px"}for(var i=0;i<this.boxNodes.length;i++){var e=this.boxNodes[i];if(this.indexes.includes(i)){var o=t.boxes[this.indexes.indexOf(i)];void 0===o?e.style.transform="scale(0)":(e.style.transform="scale(1)",e.style.height=o.height+"px",e.style.left=o.left+"px",e.style.top=o.top+"px",e.style.width=o.width+"px",this.boxObjects[i].givenAspectRatio||(e.style.opacity="1"))}else this.oldIndexes.includes(i)?e.style.transform="scale(0)":e.style.transform="scale(0)"}};