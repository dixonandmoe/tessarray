...
// Licensed under the terms of the MIT license. Please see LICENSE file in the project root for terms.
var Tessarray=function(a,b){this.options=b||{},this.setOptionValue("containerClass",!1),this.setOptionValue("selectorClass",!1),this.setOptionValue("imageClass",!1),this.setOptionValue("defaultCategory",!1),this.setOptionValue("resize",!0),this.setOptionValue("timingFunction","ease-in"),this.setOptionValue("duration",375),this.setOptionValue("delay",0),this.setOptionValue("containerTransition",{duration:375,timingFunction:"ease-in",delay:0}),this.setOptionValue("flickr",{}),this.dimensionsLoaded=[],this.containerHasLoaded=!1,this.boxObjects=[],this.boxNodes=[],this.transition="transform "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, height "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, width "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms";var c;c=this.options.containerClass?document.getElementsByClassName(this.options.containerClass)[0].getElementsByClassName(a):document.getElementsByClassName(a);for(var d=0;d<c.length;d++)this.boxNodes[d]=c[d],this.boxNodes[d].style.position="absolute",this.boxObjects[d]=new TessarrayBox(c[d],d,this);if(this.specifiedContainerWidth=!!this.options.flickr.containerWidth,this.options.containerClass){if(this.container=document.getElementsByClassName(this.options.containerClass)[0],this.container.style.opacity="0",this.options.containerTransition){var e="opacity "+this.options.containerTransition.duration+"ms "+this.options.containerTransition.timingFunction+" "+this.options.containerTransition.delay+"ms";this.container.style.transition=e,this.container.style["-webkit-transition"]=e}this.setContainerWidth(),""===this.container.style.position&&(this.container.style.position="relative"),this.options.flickr.containerPadding?this.options.flickr.containerPadding.bottom?this.containerPaddingBottom=this.options.flickr.containerPadding.bottom:this.containerPaddingBottom=this.options.flickr.containerPadding:this.containerPaddingBottom=10,this.options.resize&&window.addEventListener("resize",this.renderIfNecessary.bind(this)),this.containerLoad()}if(this.options.selectorClass){this.selectors=document.getElementsByClassName(this.options.selectorClass);for(var d=0;d<this.selectors.length;d++){var f=this.selectors[d].getAttribute("data-category");this.selectors[d].addEventListener("click",this.sortByCategory.bind(this,f))}}},TessarrayBox=function(a,b,c){this.index=b,this.tessarray=c,this.classes={};for(var d=a.getAttribute("class").split(" "),e=0;e<d.length;e++)this.classes[d[e]]=a.dataset[d[e]]||null;if(c.options.imageClass?this.image=a.getElementsByClassName(c.options.imageClass)[0]:this.image=a.querySelector("img"),this.image.style.opacity="0",this.image.style.transition="opacity "+c.options.duration+"ms ease-in",c.dimensionsLoaded[b]=!1,a.getAttribute("data-aspect-ratio")||a.getAttribute("data-height")&&a.getAttribute("data-width"))this.givenAspectRatio=!0,this.setAspectRatio(c,a,b);else{this.givenAspectRatio=!1;var f=this.image.getAttribute("src"),g=new Image,h=this;g.onload=function(){h.aspectRatio=this.width/this.height,c.confirmLoad(b)},g.src=f}};Tessarray.prototype.setOptionValue=function(a,b){void 0===this.options[a]&&(this.options[a]=b)},Tessarray.prototype.setContainerWidth=function(){!this.specifiedContainerWidth&&this.options.containerClass&&(this.options.flickr.containerWidth=this.container.clientWidth)},TessarrayBox.prototype.setAspectRatio=function(a,b,c){b.getAttribute("data-aspect-ratio")?(this.aspectRatio=parseFloat(b.getAttribute("data-aspect-ratio")),a.confirmLoad(c)):b.getAttribute("data-height")&&b.getAttribute("data-width")&&(this.aspectRatio=parseFloat(b.getAttribute("data-height"))/parseFloat(b.getAttribute("data-width")),a.confirmLoad(c));var d=this.image.getAttribute("src"),e=new Image,f=this;e.onload=function(){f.image.style.opacity="1"},e.src=d},Tessarray.prototype.confirmLoad=function(a){this.dimensionsLoaded[a]=!0,!this.deterimineIfBoxesLoaded()||!this.containerHasLoaded&&this.options.containerClass||this.initialRender()},Tessarray.prototype.containerLoad=function(){this.containerHasLoaded=!0,this.deterimineIfBoxesLoaded()&&this.initialRender()},Tessarray.prototype.deterimineIfBoxesLoaded=function(){for(var a=0;a<this.dimensionsLoaded.length;a++)if(!this.dimensionsLoaded[a])return!1;return!0},Tessarray.prototype.renderIfNecessary=function(){this.specifiedContainerWidth||this.options.flickr.containerWidth===this.container.clientWidth||this.renderBoxes()},Tessarray.prototype.initialRender=function(){this.options.containerClass&&(this.container.style.opacity="1"),this.options.selectorClass&&this.options.defaultCategory?this.sortByCategory(this.options.defaultCategory,!0):(this.setSelectedBoxes(this.boxObjects),this.renderBoxes(!0))},Tessarray.prototype.sortByCategory=function(a,b){if(""===a)var c=this.boxObjects;else var d=this.boxObjects.filter(function(b){return void 0!==b.classes[a]}),c=d.sort(function(b){return b.classes[a]});this.setSelectedBoxes(c),b===!0?this.renderBoxes(!0):this.renderBoxes()},Tessarray.prototype.setSelectedBoxes=function(a){this.selectedBoxes=a,this.indexes?this.oldIndexes=this.indexes:this.oldIndexes=[],this.indexes=this.selectedBoxes.map(function(a){return a.index}),this.ratios=a.map(function(a){return parseFloat(a.aspectRatio)})},Tessarray.prototype.scale=function(a,b){var c=a.style.transform;""!==c?a.style.transform=c.replace(/(scale\()(\d)(\))/,"$1"+b.toString()+"$3"):a.style.transform="translate(0px, 0px) scale("+b.toString()+")"},Tessarray.prototype.addTransitionToAllBoxNodes=function(a){for(var b=0;b<this.boxNodes.length;b++)this.boxNodes[b].style.transition=this.transition,this.boxNodes[b].style["-webkit-transition"]=this.transition},Tessarray.prototype.renderBoxes=function(a){this.setContainerWidth();var b=require("justified-layout")(this.ratios,this.options.flickr);if(this.options.containerClass)if(b.boxes.length>0){var c=b.boxes[b.boxes.length-1].top+b.boxes[b.boxes.length-1].height+this.containerPaddingBottom;this.container.style.height=c.toString()+"px"}else this.container.style.height="0px";a||this.addTransitionToAllBoxNodes();for(var d=0;d<this.boxNodes.length;d++){var e=this.boxNodes[d];if(this.indexes.includes(d)){var f=b.boxes[this.indexes.indexOf(d)];void 0===f?this.scale(e,0):(e.style.transform="translate("+f.left+"px, "+f.top+"px) scale(1)",e.style.height=f.height+"px",e.style.width=f.width+"px",this.boxObjects[d].givenAspectRatio||(this.boxObjects[d].image.style.opacity=""))}else this.oldIndexes.includes(d)?this.scale(e,0):this.scale(e,0)}};