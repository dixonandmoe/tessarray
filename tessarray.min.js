...
// Licensed under the terms of the MIT license. Please see LICENSE file in the project root for terms.
var Tessarray=function(t,s){this.options=s||{},this.setOptionValue("containerClass",!1),this.setOptionValue("selectorClass",!1),this.setOptionValue("defaultCategory",!1),this.setOptionValue("resize",!0),this.setOptionValue("timingFunction","ease-in"),this.setOptionValue("duration",250),this.setOptionValue("delay",0),this.setOptionValue("flickr",{}),this.boxObjects=[],this.boxNodes=[],this.dimensionsLoaded=[],this.loadNecessary=!1;for(var i=document.getElementsByClassName(t),e="transform "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, height "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, left "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, top "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, width "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, opacity "+this.options.duration+"ms "+this.options.timingFunction,o=0;o<i.length;o++)this.boxNodes[o]=i[o],this.boxNodes[o].style.position="absolute",this.boxNodes[o].style.opacity=0,this.boxObjects[o]=new TessarrayBox(i[o],o,this),this.boxNodes[o].style.transition=e,this.boxNodes[o].style["-webkit-transition"]=e;if(this.specifiedContainerWidth=!!this.options.flickr.containerWidth,this.options.containerClass&&(this.container=document.getElementsByClassName(this.options.containerClass)[0],this.setContainerWidth(),""===this.container.style.position&&(this.container.style.position="relative"),this.options.resize&&(this.setSelectedBoxes([]),window.addEventListener("resize",this.renderIfNecessary.bind(this)))),this.options.selectorClass){this.selectors=document.getElementsByClassName(this.options.selectorClass);for(var o=0;o<this.selectors.length;o++){var n=this.selectors[o].getAttribute("data-category");this.selectors[o].addEventListener("click",this.sortByCategory.bind(this,n))}}this.loadNecessary||this.initialRender()};Tessarray.prototype.initialRender=function(){this.options.selectorClass&&this.options.defaultCategory?this.sortByCategory(this.options.defaultCategory):(this.setSelectedBoxes(this.boxObjects),this.renderBoxes())},Tessarray.prototype.setOptionValue=function(t,s){void 0===this.options[t]&&(this.options[t]=s)},Tessarray.prototype.setContainerWidth=function(){!this.specifiedContainerWidth&&this.options.containerClass&&(this.options.flickr.containerWidth=this.container.clientWidth)},Tessarray.prototype.setSelectedBoxes=function(t){this.selectedBoxes=t,this.oldIndexes=this.indexes,this.indexes=this.selectedBoxes.map(function(t){return t.index}),this.ratios=t.map(function(t){return parseFloat(t.aspectRatio)})};var TessarrayBox=function(t,s,i){this.index=s,this.tessarray=i,this.classes={};for(var e=t.getAttribute("class").split(" "),o=0;o<e.length;o++)this.classes[e[o]]=t.getAttribute("data-"+e[o])||null;if(t.getAttribute("data-aspect-ratio"))this.aspectRatio=parseFloat(t.getAttribute("data-aspect-ratio"));else if(t.getAttribute("data-height")&&t.getAttribute("data-width"))this.aspectRatio=parseFloat(t.getAttribute("data-height"))/parseFloat(t.getAttribute("data-width"));else{i.loadNecessary=!0,i.dimensionsLoaded[s]=!1;var n=t.querySelector("img").getAttribute("src"),a=new Image,r=this;a.onload=function(){r.aspectRatio=this.width/this.height,i.confirmLoad(s)},a.src=n}};Tessarray.prototype.confirmLoad=function(t){this.dimensionsLoaded[t]=!0,this.deterimineIfBoxesLoaded()&&this.initialRender()},Tessarray.prototype.sortByCategory=function(t){var s=this.boxObjects.filter(function(s){return void 0!==s.classes[t]}),i=s.sort(function(s){return s.classes[t]});this.setSelectedBoxes(i),this.renderBoxes()},Tessarray.prototype.renderIfNecessary=function(){this.specifiedContainerWidth||this.options.flickr.containerWidth===this.container.clientWidth||this.renderBoxes()},Tessarray.prototype.deterimineIfBoxesLoaded=function(){for(var t=0;t<this.dimensionsLoaded.length;t++)if(this.dimensionsLoaded[t]===!1)return!1;return!0},Tessarray.prototype.renderBoxes=function(){this.setContainerWidth();for(var t=require("justified-layout")(this.ratios,this.options.flickr),s=0;s<this.boxNodes.length;s++){var i=this.boxNodes[s];if(this.indexes.includes(s)){var e=t.boxes[this.indexes.indexOf(s)];void 0===e?i.style.transform="scale(0)":(i.style.transform="scale(1)",i.style.opacity=1,i.style.height=e.height,i.style.left=e.left,i.style.top=e.top,i.style.width=e.width)}else this.oldIndexes.includes(s)&&(i.style.transform="scale(0)")}};