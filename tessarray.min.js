...
// Licensed under the terms of the MIT license. Please see LICENSE file in the project root for terms.
var Tessarray=function(t,i){window.addEventListener("load",function(){console.log("dis shit dimensionsLoaded")}),this.options=i||{},this.setOptionValue("containerClass",!1),this.setOptionValue("selectorClass",!1),this.setOptionValue("defaultCategory",!1),this.setOptionValue("resize",!0),this.setOptionValue("timingFunction","ease-in"),this.setOptionValue("duration",375),this.setOptionValue("delay",0),this.setOptionValue("flickr",{}),this.dimensionsLoaded=[],this.containerHasLoaded=!1,this.boxObjects=[],this.boxNodes=[];for(var s=document.getElementsByClassName(t),e="transform "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, height "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, left "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, top "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, width "+this.options.duration+"ms "+this.options.timingFunction+" "+this.options.delay+"ms, opacity "+this.options.duration+"ms "+this.options.timingFunction,o=0;o<s.length;o++)this.boxNodes[o]=s[o],this.boxNodes[o].style.position="absolute",this.boxNodes[o].style.opacity="0",this.boxObjects[o]=new TessarrayBox(s[o],o,this),this.boxNodes[o].style.transition=e,this.boxNodes[o].style["-webkit-transition"]=e;if(this.specifiedContainerWidth=!!this.options.flickr.containerWidth,this.options.containerClass&&(this.container=document.getElementsByClassName(this.options.containerClass)[0],this.container.style.opacity="0",this.containerLoad(),this.setContainerWidth(),""===this.container.style.position&&(this.container.style.position="relative"),this.options.flickr.containerPadding?this.options.flickr.containerPadding.bottom?this.containerPaddingBottom=this.options.flickr.containerPadding.bottom:this.containerPaddingBottom=this.options.flickr.containerPadding:this.containerPaddingBottom=10,this.options.resize&&(this.setSelectedBoxes([]),window.addEventListener("resize",this.renderIfNecessary.bind(this)))),this.options.selectorClass){this.selectors=document.getElementsByClassName(this.options.selectorClass);for(var o=0;o<this.selectors.length;o++){var n=this.selectors[o].getAttribute("data-category");this.selectors[o].addEventListener("click",this.sortByCategory.bind(this,n))}}},TessarrayBox=function(t,i,s){this.index=i,this.tessarray=s,this.classes={};for(var e=t.getAttribute("class").split(" "),o=0;o<e.length;o++)this.classes[e[o]]=t.dataset[e[o]]||null;if(t.getAttribute("data-aspect-ratio")||t.getAttribute("data-height")&&t.getAttribute("data-width"))s.setAspectRatio(s,this,t,i);else{s.dimensionsLoaded[i]=!1;var n=t.querySelector("img").getAttribute("src"),a=new Image,r=this;a.onload=function(){r.aspectRatio=this.width/this.height,s.confirmLoad(i)},a.src=n}};Tessarray.prototype.setOptionValue=function(t,i){void 0===this.options[t]&&(this.options[t]=i)},Tessarray.prototype.setContainerWidth=function(){!this.specifiedContainerWidth&&this.options.containerClass&&(this.options.flickr.containerWidth=this.container.clientWidth)},Tessarray.prototype.setAspectRatio=function(t,i,s,e){t.dimensionsLoaded[e]=!1,s.getAttribute("data-aspect-ratio")?i.aspectRatio=parseFloat(s.getAttribute("data-aspect-ratio")):s.getAttribute("data-height")&&s.getAttribute("data-width")&&(i.aspectRatio=parseFloat(s.getAttribute("data-height"))/parseFloat(s.getAttribute("data-width")));var o=s.querySelector("img");o.addEventListener("load",t.confirmLoad.bind(t,e))},Tessarray.prototype.confirmLoad=function(t){this.dimensionsLoaded[t]=!0,!this.deterimineIfBoxesLoaded()||!this.containerHasLoaded&&this.options.containerClass||this.initialRender()},Tessarray.prototype.containerLoad=function(){this.containerHasLoaded=!0,this.deterimineIfBoxesLoaded()&&this.initialRender()},Tessarray.prototype.deterimineIfBoxesLoaded=function(){for(var t=0;t<this.dimensionsLoaded.length;t++)if(!this.dimensionsLoaded[t])return!1;return!0},Tessarray.prototype.renderIfNecessary=function(){this.specifiedContainerWidth||this.options.flickr.containerWidth===this.container.clientWidth||this.renderBoxes()},Tessarray.prototype.initialRender=function(){this.options.containerClass&&(this.container.style.opacity="1"),this.options.selectorClass&&this.options.defaultCategory?this.sortByCategory(this.options.defaultCategory):(this.setSelectedBoxes(this.boxObjects),this.renderBoxes())},Tessarray.prototype.sortByCategory=function(t){if(""===t)var i=this.boxObjects;else var s=this.boxObjects.filter(function(i){return void 0!==i.classes[t]}),i=s.sort(function(i){return i.classes[t]});this.setSelectedBoxes(i),this.renderBoxes()},Tessarray.prototype.setSelectedBoxes=function(t){this.selectedBoxes=t,this.oldIndexes=this.indexes,this.indexes=this.selectedBoxes.map(function(t){return t.index}),this.ratios=t.map(function(t){return parseFloat(t.aspectRatio)})},Tessarray.prototype.renderBoxes=function(){this.setContainerWidth();var t=require("justified-layout")(this.ratios,this.options.flickr);this.options.containerClass&&(this.container.style.height=t.boxes[t.boxes.length-1].top+t.boxes[t.boxes.length-1].height+this.containerPaddingBottom);for(var i=0;i<this.boxNodes.length;i++){var s=this.boxNodes[i];if(this.indexes.includes(i)){var e=t.boxes[this.indexes.indexOf(i)];void 0===e?s.style.transform="scale(0)":(s.style.transform="scale(1)",s.style.opacity="1",s.style.height=e.height+"px",s.style.left=e.left+"px",s.style.top=e.top+"px",s.style.width=e.width+"px")}else this.oldIndexes.includes(i)?s.style.transform="scale(0)":s.style.transform="scale(0)"}};